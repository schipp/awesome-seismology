...
- [PyLith](https://github.com/geodynamics/pylith) - Finite-element simulations of dynamic and quasi-static crustal deformation, primarily earthquakes and volcanoes. ![python](assets/python.png)
- [QDYN](https://github.com/ydluo-c/qdyn) - A quasi-dynamic earthquake simulator. ![matlab](assets/matlab.png) ![python](assets/python.png)
...
- [DASPack](https://github.com/asleix/daspack) - Controlled data compression for Distributed Acoustic Sensing. ![python](assets/python.png)
...
- [Lightguide](https://github.com/pyrocko/lightguide) - Package for handling, filtering and modelling Distributed Acoustic Sensing (DAS) data. ![python](assets/python.png)
...
- [SAC](https://ds.iris.edu/ds/nodes/dmc/software/downloads/sac/) - The classic interactive waveform analysis program for research seismologists.
...
- [Vectorizing Legacy Seismograms](https://github.com/RDePlaen/VectorizationTools) - Tools & references for handling scanned legacy (analogue) seismograms.
...
- [Geopsy](https://www.geopsy.org) - Tools for ambient vibration analysis and site characterisation, including HVSR.
...
- [ETAS](https://github.com/jalilian/ETAS) - Fitting the space-time epidemic-type aftershock sequence (ETAS) model to earthquake data. ![r](assets/r.png)
